...
Arduino_DataBus *bus = new Arduino_SWSPI(
    ...
    17 /* SCK */, 18 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
#define RGB_PANEL
Arduino_ESP32RGBPanel *rgbpanel = new Arduino_ESP32RGBPanel(
    21 /* DE */, 18 /* VSYNC */, 17 /* HSYNC */, 0 /* PCLK */,
    5 /* R0 */, 4 /* R1 */, 3 /* R2 */, 2 /* R3 */, 1 /* R4 */,
    11 /* G0 */, 10 /* G1 */, 9 /* G2 */, 8 /* G3 */, 7 /* G4 */, 6 /* G5 */,
    16 /* B0 */, 15 /* B1 */, 14 /* B2 */, 13 /* B3 */, 12 /* B4 */,
    1 /* hsync_polarity */, 20 /* hsync_front_porch */, 8 /* hsync_pulse_width */, 20 /* hsync_back_porch */,
    1 /* vsync_polarity */, 32 /* vsync_front_porch */, 2 /* vsync_pulse_width */, 20 /* vsync_back_porch */,
    0 /* pclk_active_neg */, 16000000 /* prefer_speed */, false /* useBigEndian */,//最佳速度160000000
    0 /* de_idle_high */, 0 /* pclk_idle_high */, 0 /* bounce_buffer_size_px */);
Arduino_RGB_Display *gfx = new Arduino_RGB_Display(
    420 /* width */, 960 /* height */, rgbpanel, 1 /* rotation */, true /* auto_flush */,
    bus, GFX_NOT_DEFINED /* RST */, gc9503v_type3_init_operations, sizeof(gc9503v_type3_init_operations));
